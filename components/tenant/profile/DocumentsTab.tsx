...
export default function DocumentsTab({ profile, onDocumentClick, getDocumentUrl, isMobile = false }: DocumentsTabProps) {
    ...
    <div className={`space-y-4 ${isMobile ? 'space-y-4' : 'space-y-6'}`}>
      ...
      <Card>
        <CardHeader className={isMobile ? 'px-4 py-3' : ''}>
          <CardTitle className={isMobile ? 'text-base' : ''}>Profile Photo</CardTitle>
          <CardDescription className={isMobile ? 'text-xs' : ''}>Your profile picture</CardDescription>
        </CardHeader>
        <CardContent className={isMobile ? 'px-4 py-3' : ''}>
          {profile.photo_url ? (
            <div className={`flex ${isMobile ? 'flex-col' : 'flex-col md:flex-row'} items-start gap-4`}>
            ...
            <div className={`text-center ${isMobile ? 'py-6' : 'py-8'}`}>
              <User className={`${isMobile ? 'h-12 w-12' : 'h-16 w-16'} mx-auto text-gray-400 mb-4`} />
      ...
      <Card>
        <CardHeader className={isMobile ? 'px-4 py-3' : ''}>
          <CardTitle className={isMobile ? 'text-base' : ''}>ID Proof Document</CardTitle>
          <CardDescription className={isMobile ? 'text-xs' : ''}>Government issued identification</CardDescription>
        </CardHeader>
        <CardContent className={isMobile ? 'px-4 py-3' : ''}>
          {profile.id_proof_url ? (
            <div className="space-y-3">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <div className="flex items-start gap-3">
                  <FileText className={`${isMobile ? 'h-4 w-4' : 'h-5 w-5'} text-blue-600 mt-0.5 flex-shrink-0`} />
                  <div>
                    <p className={`font-semibold text-blue-900 ${isMobile ? 'text-sm' : ''}`}>ID Proof Details</p>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
              <div className="flex items-start gap-3">
                <Shield className={`${isMobile ? 'h-4 w-4' : 'h-5 w-5'} text-yellow-600 mt-0.5 flex-shrink-0`} />
                <div>
                  <p className={`font-semibold text-yellow-900 ${isMobile ? 'text-sm' : ''}`}>ID Proof Required</p>
      ...
      <Card>
        <CardHeader className={isMobile ? 'px-4 py-3' : ''}>
          <CardTitle className={isMobile ? 'text-base' : ''}>Address Proof Document</CardTitle>
          <CardDescription className={isMobile ? 'text-xs' : ''}>Document verifying your address</CardDescription>
        </CardHeader>
        <CardContent className={isMobile ? 'px-4 py-3' : ''}>
          {profile.address_proof_url ? (
            <div className="space-y-3">
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                <div className="flex items-start gap-3">
                  <MapPin className={`${isMobile ? 'h-4 w-4' : 'h-5 w-5'} text-green-600 mt-0.5 flex-shrink-0`} />
                  <div>
                    <p className={`font-semibold text-green-900 ${isMobile ? 'text-sm' : ''}`}>Address Proof Details</p>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
              <div className="flex items-start gap-3">
                <MapPin className={`${isMobile ? 'h-4 w-4' : 'h-5 w-5'} text-yellow-600 mt-0.5 flex-shrink-0`} />
                <div>
                  <p className={`font-semibold text-yellow-900 ${isMobile ? 'text-sm' : ''}`}>Address Proof Required</p>
                  <p className="text-xs text-yellow-700 mt-1">
      ...
      <Card>
        <CardHeader className={isMobile ? 'px-4 py-3' : ''}>
          <CardTitle className={isMobile ? 'text-base' : ''}>Additional Documents</CardTitle>
          <CardDescription className={isMobile ? 'text-xs' : ''}>Other supporting documents</CardDescription>
        </CardHeader>
        <CardContent className={isMobile ? 'px-4 py-3' : ''}>
          {profile.additional_documents && profile.additional_documents.length > 0 ? (
            ...
            <div className={`text-center ${isMobile ? 'py-6' : 'py-8'}`}>
              <FileText className={`${isMobile ? 'h-12 w-12' : 'h-16 w-16'} mx-auto text-gray-400 mb-4`} />
