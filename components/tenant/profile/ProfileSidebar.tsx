      ...
      <div className="bg-gradient-to-r from-[#004aad] to-[#002a7a] rounded-2xl p-4 shadow-lg mb-2">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-white font-bold text-md truncate">{profile.full_name}</h2>
      ...
      <div className="relative mb-6">
        ...
        <div className="relative text-center pt-2">
          ...
          <div className="relative inline-block mb-4">
            ...
            <Avatar className="h-28 w-28 border-4 border-white shadow-xl relative mx-auto">
              <AvatarImage 
                src={profile.photo_url || ""} 
                alt={profile.full_name} 
                className="object-cover"
          ...
          {/* Name */}
          <h2 className="text-xl md:text-xl font-bold text-slate-800 mb-2">
            {profile.full_name}
          </h2>
