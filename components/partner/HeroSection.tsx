...
export const HeroSection = forwardRef<HTMLElement, HeroSectionProps>(
  ({ id, visible }, ref) => (
    <section
      ref={ref}
      id={id}
      className={`relative bg-gradient-to-br from-blue-200 to-slate-100 py-10 overflow-hidden transition-all duration-1000 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
    >
