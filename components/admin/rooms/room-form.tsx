              ...
              <div className="space-y-1.5 md:space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    value={formData.capacity}
                    onChange={(e) => handleCapacityChange(e.target.value)}
                    className="h-7 md:h-8 text-[10px] md:text-xs mt-0.5 pr-10"
                    placeholder="Enter number of beds"
                  />
                  {!formData.isManualCapacity && formData.sharing_type && formData.sharing_type !== 'other' && (
                    <div className="absolute right-2 top-1/2 transform -translate-y-1/2">
                      <Badge variant="outline" className="text-[9px] md:text-[10px] bg-green-50 text-green-700 border-green-300 px-1 py-0">
                        Auto
                      </Badge>
                    </div>
                  )}
                ...
                {!formData.isManualCapacity && formData.sharing_type && formData.sharing_type !== 'other' && (
                  <p className="text-[9px] md:text-[10px] text-green-600 mt-0.5 flex items-center gap-0.5">
