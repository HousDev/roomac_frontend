...
<DialogContent 
className="max-w-xl md:max-w-[600px] max-h-[75vh] overflow-hidden flex flex-col border border-gray-300 shadow-xl p-0 rounded-2xl"  onInteractOutside={(e) => e.preventDefault()}
