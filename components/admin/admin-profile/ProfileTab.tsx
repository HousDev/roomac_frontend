  ...
  return (
    <>
      <style>{`
        ...
        .pt-sel:focus { border-color: #3B82F6; box-shadow: 0 0 0 3px rgba(59,130,246,.12); }
        .pt-sel:disabled { opacity: .6; cursor: not-allowed; }
        .pt-inp-ta {
        ...
        @media (max-width: 640px) {
          .pt-banner { padding: 20px 18px 60px; }
          .pt-banner-title { font-size: 16px; }
          .pt-banner-sub { font-size: 12px; }
          .pt-av-section { padding: 0 12px; margin-top: -38px; }
          .pt-av-card { padding: 14px 14px; gap: 12px; border-radius: 16px; flex-direction: row; align-items: flex-start; }
          ...
          .pt-sel { font-size: 13px; padding: 9px 8px; border-radius: 10px; }
      ...
      <div className="pt-wrap">
          ...
          <div className="pt-av-card">
            <div className="pt-av-ring">
              <div className="pt-av-inner">
                <Avatar className="w-full h-full rounded-full">
                  {avatarSrc && (
                    <AvatarImage src={avatarSrc} alt={profileData.full_name} className="object-cover w-full h-full" />
                  )}
                  <AvatarFallback style={{
                    fontSize: 28, fontWeight: 800,
                    background: 'linear-gradient(135deg,#E0E7FF,#C7D2FE)',
                    color: '#4F46E5', width: '100%', height: '100%',
              ...
              <button type="button" className="pt-av-cam" onClick={handleCameraClick} disabled={avatarUploading} aria-label="Upload profile photo">
                {avatarUploading
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div className="pt-av-name">
                {profileData.salutation ? `${salutationLabel(profileData.salutation)} ` : ''}{profileData.full_name || 'Your Name'}
              </div>
              <div className="pt-av-meta">
                <span className="pt-role-pill">{displayRole}</span>
                <span className="pt-active-dot"><span className="pt-dot" />Active</span>
              </div>
              <div className="pt-av-btns">
                <Button type="button" variant="outline" onClick={handleRemovePhoto}
                  ...
                  style={{ color: '#DC2626', borderColor: '#FECACA', borderRadius: 12, fontSize: 13, fontWeight: 600, gap: 7, paddingLeft: 18, paddingRight: 18 }}
                ...
                <Button type="button" onClick={onSave} disabled={loading || avatarUploading}
                  style={{ background: 'linear-gradient(135deg,#2563EB,#1E4ED8)', borderRadius: 12, fontSize: 13, fontWeight: 600, gap: 7, paddingLeft: 18, paddingRight: 18, boxShadow: '0 4px 16px rgba(37,99,235,.28)', border: 'none' }}
                  className="hover:opacity-90 transition-all duration-200">
                  {loading
                    ? <><Loader2 className="h-4 w-4 text-white animate-spin" /><span className="av-btn-text">Saving...</span></>
                    : <><Save className="h-4 w-4" /><span className="av-btn-text">Save Changes</span></>}
                </Button>
              </div>
            </div>
          </div>
        ...
        <div className="pt-form">
          ...
          {/* Row 1: Full Name (with salutation) + Role */}
          <div className="pt-g2">
            <div className="pt-field">
              <Label className="pt-lbl">Full Name <span className="pt-lbl-req">*</span></Label>
            ...
            <div className="pt-field">
              ...
              <input className="pt-inp disabled-inp" value={displayRole} disabled readOnly />
            </div>
          </div>

          {/* Row 2: Email + Phone (with country code) */}
          <div className="pt-g2">
            <div className="pt-field">
              <Label className="pt-lbl">Email <span className="pt-lbl-req">*</span></Label>
              <div className="pt-inp-wrap">
                <span className="pt-inp-ico"><Mail size={15} /></span>
                <input
            ...
            <div className="pt-field">
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                <select
                  className="pt-sel"
                  value={profileData.phone_country_code || '+91'}
                ...
                <div className="pt-inp-wrap" style={{ flex: 1 }}>
                  <span className="pt-inp-ico"><Phone size={15} /></span>
                  <input
          ...
          <div className="pt-g1 pt-field">
            ...
            <div className="pt-inp-wrap">
              <span className="pt-inp-ico"><MapPin size={15} /></span>
              <input
                className="pt-inp with-icon"
        ...
        <div className="pt-footer">
          <Button type="button" variant="ghost" onClick={onCancel} disabled={loading}
            style={{ color: '#475569', borderRadius: 12, fontSize: 13, fontWeight: 600, paddingLeft: 20, paddingRight: 20, border: '1.5px solid #E2E8F0' }}
