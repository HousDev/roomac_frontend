...
//   useEffect(() => {
//     console.log('🔍 DataTable - Initial props:', {
...
//   // Initialize filters with empty values (NOT with first option!)
//   useEffect(() => {
//     const defaultFilters: Record<string, string> = {};
//     filters.forEach(filter => {
//       // Set to empty string, NOT first option
...
//       console.log('🔍 DataTable - Initialized filters:', defaultFilters);
//     }
//   }, [filters]);
...
//     console.log('🔍 DataTable - Filter changed:', { key, value, newFilters });
//   };
...
//   // Apply search - FIXED to handle nested objects
//   const searchFilteredData = useMemo(() => {
//     if (!searchTerm.trim()) return data;
    
//     const searchLower = searchTerm.toLowerCase();
//     console.log('🔍 DataTable - Applying search:', searchLower);
...
//   // Apply filters - FIXED to handle boolean values correctly
...
//       if (value && value.trim() !== '') {
//         console.log('🔍 DataTable - Applying filter:', { key, value });
...
//     console.log('🔍 DataTable - After filtering:', {
//       initialCount: data.length,
//       afterSearchCount: searchFilteredData.length,
...
//     return result;
//   }, [searchFilteredData, activeFilters, data.length]);

//   // Apply sorting
//   const sortedData = useMemo(() => {
//     if (!sortKey) return filteredData;
    
//     console.log('🔍 DataTable - Applying sort:', { sortKey, sortOrder });
...
//   useEffect(() => {
//     console.log('🔍 DataTable - Final state:', {
//       totalData: data.length,
//       searchFiltered: searchFilteredData.length,
//       finalFiltered: filteredData.length,
...
//       sortOrder
//     });
//   }, [data.length, searchFilteredData.length, filteredData.length, sortedData.length, paginatedData.length, currentPage, totalPages, activeFilters, searchTerm, sortKey, sortOrder]);
...
//                           // Handle indeterminate state - select all
//                           setSelectedRows(paginatedData);
//                         } else {
