...
const getServiceIcon = (service: string) => {
  ...
  // Food & Dining
  if (lower.includes('food') || lower.includes('meal')) return <Utensils className="h-4 w-4" />;
  
  // Cleaning & Maintenance
  if (lower.includes('cleaning') || lower.includes('housekeeping')) return <Brush className="h-4 w-4" />;
  if (lower.includes('laundry')) return <WashingMachine className="h-4 w-4" />;
  if (lower.includes('maintenance')) return <Wrench className="h-4 w-4" />;
  
  // Medical & Health
  if (lower.includes('medical') || lower.includes('health')) return <Heart className="h-4 w-4" />;
  if (lower.includes('ambulance') || lower.includes('emergency')) return <Ambulance className="h-4 w-4" />;
  
  // Transportation
  if (lower.includes('transport') || lower.includes('pickup')) return <Car className="h-4 w-4" />;
  
  // Concierge & Assistance
  if (lower.includes('concierge')) return <UserCheck className="h-4 w-4" />;
  if (lower.includes('package') || lower.includes('parcel')) return <Package className="h-4 w-4" />;
