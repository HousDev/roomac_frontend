...
//   const handleRemoveBadge = (optionName: string, e: React.MouseEvent) => {
//     e.stopPropagation();
//     onChange(selected.filter(item => item !== optionName));
//   };
...
//         className={`w-full px-3 py-1.5 border rounded-lg text-[10px] md:text-xs flex items-center justify-between bg-white ${
...
//           ) : options.length > 0 ? (
//             options.map((option) => {
//               const isItemSelected = selected.includes(option.name);
//               return (
//                 <div
//                   key={option.id}
...
//                     isItemSelected ? 'bg-blue-600 border-blue-600' : 'border-gray-300 bg-white'
//                   }`}>
//                     {isItemSelected && <Check className="h-2.5 w-2.5 text-white" />}
//                   </div>
//                   <span className={`text-[10px] md:text-xs ${
//                     isItemSelected ? 'text-blue-700 font-medium' : 'text-gray-700'
//                   }`}>
//                     {option.name}
//                   </span>
//                 </div>
...
//       {selected.length > 0 && (
//         <div className="flex flex-wrap gap-1 p-2 bg-gray-50 rounded-lg border mt-2">
//           {selected.map((value) => (
//             <span 
//               key={value} 
//               className="bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded text-[9px] md:text-[10px] flex items-center gap-0.5"
//             >
//               {value}
//               <button
//                 type="button"
//                 onClick={(e) => handleRemoveBadge(value, e)}
//                 className="ml-0.5 hover:text-red-500 focus:outline-none"
//               >
