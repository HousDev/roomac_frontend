...
const [columnFilters, setColumnFilters] = useState({
  ...
  if (showFilterSidebar) {
    ...
    setDraftProperty(columnFilters.property);
    setDraftDateFilters(dateFilters);
  }
}, [showFilterSidebar]); // eslint-disable-line react-hooks/exhaustive-deps
...
const [draftProperty, setDraftProperty] = useState(columnFilters.property);
    ...
    <option key={p.id} value={p.name}>{p.name}</option>
        ...
        <div className="border-t border-dashed border-gray-200 pt-2">
          ...
          <label className="flex items-center gap-2 p-2 rounded-lg border border-gray-200 bg-gray-50 cursor-pointer mb-3">
            <input
  type="checkbox"
  checked={draftDateFilters.ignoreDateFilters}
  onChange={(e) => setDraftDateFilters(prev => ({ ...prev, ignoreDateFilters: e.target.checked }))}
...
/>
          ...
          {/* Move-in Date Range */}
          <div className={`space-y-1 mb-3 ${draftDateFilters.ignoreDateFilters ? 'opacity-40 pointer-events-none' : ''}`}>
  ...
  <div className="grid grid-cols-2 gap-2">
    <div className="space-y-0.5">
      ...
      <Input
        type="date"
        value={draftDateFilters.moveInFrom}
        onChange={(e) => setDraftDateFilters(prev => ({ ...prev, moveInFrom: e.target.value }))}
    ...
    <div className="space-y-0.5">
      ...
      <Input
        type="date"
        value={draftDateFilters.moveInTo}
        onChange={(e) => setDraftDateFilters(prev => ({ ...prev, moveInTo: e.target.value }))}
        className="h-7 text-xs px-2 w-full"
      />
    </div>
  </div>
...
<div className={`space-y-1 ${draftDateFilters.ignoreDateFilters ? 'opacity-40 pointer-events-none' : ''}`}>
  ...
  <div className="grid grid-cols-2 gap-2">
    <div className="space-y-0.5">
      ...
      <Input
        type="date"
        value={draftDateFilters.createdFrom}
        onChange={(e) => setDraftDateFilters(prev => ({ ...prev, createdFrom: e.target.value }))}
        className="h-7 text-xs px-2 w-full"
      />
    </div>
    <div className="space-y-0.5">
      ...
      <Input
        type="date"
        value={draftDateFilters.createdTo}
        onChange={(e) => setDraftDateFilters(prev => ({ ...prev, createdTo: e.target.value }))}
        className="h-7 text-xs px-2 w-full"
      />
    </div>
  </div>
  ...
  <Button
    ...
    onClick={() => {
      ...
      setColumnFilters(prev => ({ ...prev, property: draftProperty }));
