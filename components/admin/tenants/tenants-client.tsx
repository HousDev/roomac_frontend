...
//     <div className="p-2">
//       <Card className="border-0 shadow-lg">
//       <CardHeader className="sticky top-16 z-10 bg-gradient-to-r from-blue-600 via-blue-500 to-blue-500 text-white shadow-md border-b py-2 px-3 md:px-4 rounded-xl -translate-y-1">
//   <div className="flex flex-col gap-2">
//     {/* Desktop View */}
//     <div className="hidden md:block">
//       {/* Actions Row - Like PropertyHeader's button row */}
//       <div className="flex items-center justify-between">
//         {/* LEFT: Icon + Search */}
//         <div className="flex items-center gap-3">
...
//         {/* RIGHT: Buttons - Exactly like PropertyHeader */}
//         <div className="flex items-center gap-2">
//           {/* Refresh */}
//           <Button
//             size="icon"
...
//         {/* STATUS & ACCESS — 3 filters in compact rows */}
...
//         {/* PERSONAL INFORMATION — 2 filters side by side */}
//         <div className="rounded-lg border border-blue-100 overflow-hidden">
//           <div className="px-3 py-1.5" style={{ backgroundColor: '#e6f0ff' }}>
//             <span className="text-[10px] font-bold uppercase tracking-widest" style={{ color: '#004ab0' }}>
...
//         {/* LOCATION — 2 inputs side by side */}
//         <div className="rounded-lg border border-blue-100 overflow-hidden">
...
//       {/* Bottom Row: Active Filters - Like PropertyHeader */}
//       {activeFiltersCount > 0 && (
...
//     {/* Mobile View - Exactly like PropertyHeader's MobileHeader pattern */}
//     <div className="md:hidden">
//       {/* Top Row: Icon + Title + Bulk Count + Action Icons */}
//       <div className="flex items-center justify-between mb-2">
//         {/* Left: Icon + Title + Bulk Button */}
...
//           {/* Bulk Button next to title - Like PropertyHeader */}
//           {selectedTenantIds.length > 0 ? (
//             <DropdownMenu>
//               <DropdownMenuTrigger asChild>
//                 <Button
...
//         {/* Right: Action Icons + Add Button - Like PropertyHeader */}
//         <div className="flex items-center gap-1">
//           <Button
//             size="icon"
//             variant="ghost"
...
//           {/* Add Tenant Button - Like PropertyHeader's Add button */}
//           <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
//             <DialogTrigger asChild>
//               <Button
//                 size="sm"
...
//       {/* Compact Search Bar - Like PropertyHeader */}
...
//       {/* Active Filters Indicator - Like PropertyHeader */}
//       {activeFiltersCount > 0 && (
