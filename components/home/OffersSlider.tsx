...
//       <div className="relative z-10 max-w-5xl max-h-3xl mx-auto">
//         <div className="mb-2">
//           <div className="">
...
//                       className={`h-2 rounded-full transition-all duration-300 shadow-lg ${currentOfferIndex === index
//                           ? 'w-6 bg-blue-600'
...
export default function OffersSlider({ offers }: OffersSliderProps) {
  ...
  return (
    ...
    <section className="py-8 px-3 relative overflow-hidden bg-gradient-to-br from-blue-50 to-white">
        ...
        <div className="w-full h-full opacity-80">
          ...
          >
            <defs>
              ...
              <linearGradient id="accentGrad" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" style={{ stopColor: '#004aad', stopOpacity: 0.1 }} />
                <stop offset="100%" style={{ stopColor: '#004aad', stopOpacity: 0.15 }} />
              </linearGradient>

              <radialGradient id="glowGrad" cx="50%" cy="50%">
                <stop offset="0%" style={{ stopColor: '#ffffff', stopOpacity: 0.8 }} />
                <stop offset="100%" style={{ stopColor: '#004aad', stopOpacity: 0.05 }} />
              </radialGradient>
            </defs>
            ...
            <path d="M 0,400 Q 200,350 400,400 T 800,400" stroke="#004aad" strokeWidth="2" fill="none" opacity="0.15" />
            <path d="M 600,100 Q 800,150 1000,100 T 1400,100" stroke="#ffbe11" strokeWidth="2" fill="none" opacity="0.15" />

            <g opacity="0.2">
              <circle cx="150" cy="300" r="3" fill="#004aad" />
              <circle cx="180" cy="320" r="3" fill="#004aad" />
              <circle cx="210" cy="340" r="3" fill="#004aad" />
              <circle cx="1250" cy="400" r="3" fill="#ffbe11" />
              <circle cx="1280" cy="420" r="3" fill="#ffbe11" />
              <circle cx="1310" cy="440" r="3" fill="#ffbe11" />
              <circle cx="100" cy="600" r="3" fill="#004aad" />
              <circle cx="130" cy="620" r="3" fill="#004aad" />
              <circle cx="160" cy="640" r="3" fill="#004aad" />
            </g>
            ...
            <g stroke="#004aad" strokeWidth="0.5" opacity="0.08">
              <line x1="0" y1="200" x2="1400" y2="200" />
              <line x1="0" y1="400" x2="1400" y2="400" />
              <line x1="0" y1="600" x2="1400" y2="600" />
              <line x1="300" y1="0" x2="300" y2="900" />
            ...
            <path d="M 0,0 Q 350,80 700,40 T 1400,0 L 1400,0 L 0,0 Z" fill="#004aad" opacity="0.05" />

            <path d="M 0,900 Q 350,820 700,860 T 1400,900 L 1400,900 L 0,900 Z" fill="#ffbe11" opacity="0.05" />

            <g opacity="0.6">
              <circle cx="400" cy="250" r="2" fill="#ffbe11">
                <animate attributeName="opacity" values="0.3;1;0.3" dur="2s" repeatCount="indefinite" />
              </circle>
              <circle cx="900" cy="180" r="2" fill="#ffbe11">
                <animate attributeName="opacity" values="0.3;1;0.3" dur="2.5s" repeatCount="indefinite" />
              </circle>
              <circle cx="1100" cy="550" r="2" fill="#ffbe11">
                <animate attributeName="opacity" values="0.3;1;0.3" dur="3s" repeatCount="indefinite" />
              </circle>
              <circle cx="250" cy="700" r="2" fill="#ffbe11">
                <animate attributeName="opacity" values="0.3;1;0.3" dur="2.2s" repeatCount="indefinite" />
              </circle>
            </g>

            <path d="M 1300,300 L 1350,250 L 1400,300 L 1350,350 Z" fill="#ffbe11" opacity="0.1">
              <animateTransform attributeName="transform" type="scale" values="1;1.1;1" dur="4s" repeatCount="indefinite" additive="sum" />
            </path>

            <path d="M 100,800 L 150,750 L 200,800 L 150,850 Z" fill="#004aad" opacity="0.1">
              <animateTransform attributeName="transform" type="scale" values="1;1.15;1" dur="3.5s" repeatCount="indefinite" additive="sum" />
            </path>
          </svg>
        </div>
      ...
      {/* Content - ONLY HEIGHT INCREASED, UI UNCHANGED */}
      <div className="relative z-10 max-w-5xl mx-auto">
        <div className="mb-2">
          <div className="">
            <div className="flex flex-col items-center mb-3 md:mb-1">
              <div className="inline-flex items-center justify-center mb-2 sm:mb-3">
                <div className="h-1 w-4 sm:h-1.5 sm:w-6 bg-[#004aad] rounded-full"></div>
                <span className="mx-2 sm:mx-3 text-[10px] sm:text-xs font-semibold text-[#004aad] tracking-wider uppercase">
                  Limited Time Offers
                </span>
                <div className="h-1 w-4 sm:h-1.5 sm:w-6 bg-[#004aad] rounded-full"></div>
              </div>

              <h2 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-2 sm:mb-3 text-center backdrop-blur-sm px-3 py-1 rounded-lg">
                <span className="text-gray-700">Special</span>
                <span className="text-[#ffbe11] ml-1 sm:ml-2">Offers</span>
              </h2>
            </div>
            ...
            {(() => {
              return activeOffers.length > 2 ? (
                <div className="flex gap-1.5 justify-end items-end">
                  <button
                    onClick={() => handlePrevOfferSlide()}
                    className="p-1.5 rounded-full bg-white border border-[#004aad] hover:bg-blue-50 transition-colors shadow-lg"
                  >
                    <ChevronLeft className="h-3.5 w-3.5 text-[#004aad]" />
                  </button>
                  <button
                    onClick={() => handleNextOfferSlide()}
                    className="p-1.5 rounded-full bg-white border border-[#004aad] hover:bg-blue-50 transition-colors shadow-lg"
                  >
                    <ChevronRight className="h-3.5 w-3.5 text-[#004aad]" />
                  </button>
                </div>
              ) : null;
            })()}
        ...
        {/* Slider Container - ONLY HEIGHT INCREASED */}
        <div className="relative">
          <div>
            {(() => {
              // If no active offers, show message
              if (activeOffers.length === 0) {
                return (
                  <div className="w-full flex-shrink-0 px-2">
                    <div className="text-center py-8 bg-white/80 backdrop-blur-sm rounded-xl border border-[#004aad]/20">
                      <div className="text-3xl mb-2">🏠</div>
                      <h3 className="text-lg font-bold text-[#004aad] mb-1">No Active Offers Available</h3>
                      <p className="text-sm text-gray-600">Check back soon for new special offers!</p>
                    </div>
                  </div>
                );
              }
                  ...
                  <div key={slideIndex} className="w-full flex-shrink-0 px-2">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-[30px] md:gap-[40px]">
                      {slideOffers.map((offer, index) => (
                        <div
                          key={offer.id || index}
                          className="bg-white/95 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg border border-[#004aad]/20 transition-all transform hover:-translate-y-1.5 hover:shadow-xl cursor-pointer"
                          onClick={() => {
                            setSelectedOffer(offer);
                            setIsClaimPopupOpen(true);
                          }}
                        >
                          {/* ===== TOP IMAGE - HEIGHT INCREASED ONLY ===== */}
                          <div className="relative w-full h-[140px] md:h-[200px]">
                            <img
                              src={offer.image || "https://images.pexels.com/photos/271624/pexels-photo-271624.jpeg"}
                              alt="Interior"
                              className="w-full h-full object-cover rounded-t-xl"
                            ...
                            {/* BRAND OVERLAY - UNCHANGED */}
                            <div className="absolute top-2 left-2 px-2 py-1 rounded bg-white/90 backdrop-blur-sm border-l-4 border-[#ffbe11]">
                              <p className="text-xs md:text-sm font-semibold text-[#004aad]">
                                {offer.property_name || "SOUL SPACE"}
                              </p>
                            </div>
                          </div>

                          {/* ===== MOBILE CONTENT - ONLY PADDING INCREASED, UI UNCHANGED ===== */}
                          <div className="md:hidden">
                            <div className="p-4">
                              {/* Title and Price - UNCHANGED */}
                              <div className="flex justify-between items-start mb-2.5">
                                <div>
                                  ...
                                  <div className="mt-0.5">
                                    <p className="text-xl font-extrabold text-[#ffbe11]">
                                      ₹{offer.discounted_price || offer.final_price || "8000"} /-
                                    </p>
                                    {offer.original_price || offer.actual_price ? (
                                ...
                                <div className="bg-[#ffbe11] text-[#004aad] px-2 py-1.5 rounded text-[9px] min-w-[55px] shadow-md">
                                  <p className="uppercase font-bold text-[8px]">Discount</p>
                                  <div className="text-base font-black">
                                    {offer.discount_value != null && offer.discount_value > 0 ? (
                                      <div className="text-sm">₹{Math.floor(Number(offer.discount_value))}</div>
                                    ) : offer.discount_percentage || offer.discount_percent ? (
                                      <div className="text-sm">{offer.discount_percentage || offer.discount_percent}%</div>
                                    ) : (
                              ...
                              {/* Features - UNCHANGED */}
                              <div className="mb-0">
                                <h3 className="text-[10px] font-bold text-[#004aad] mb-1">
                                  WHY CHOOSE US?
                                </h3>
                                <ul className="text-[10px] text-gray-600 space-y-0.5">
                                  {(offer.features || [
                                    ...
                                    <li key={idx} className="flex items-start gap-1">
                                      <span className="text-[#ffbe11] text-xs">•</span>
                                      <span className="truncate">{point.length > 35 ? point.substring(0, 35) + "..." : point}</span>
                                    </li>
                                  ))}
                                </ul>
                              </div>

                              {/* Validity Badge - UNCHANGED */}
                              {(offer.start_date || offer.end_date || offer.valid_from || offer.valid_to) && (
                                <div className="mb-1.5">
                                  <div className="relative inline-block">
                                    <div className="bg-[#004aad] text-white px-2 py-1 pr-4 rounded-sm shadow-md skew-x-[-10deg]">
                                      <div className="skew-x-[10deg]">
                                        <p className="text-[7px] font-extrabold uppercase leading-tight text-[#ffbe11]">
                                          LIMITED TIME
                                        </p>
                                    ...
                                    <span className="absolute top-0 right-0 h-full w-1.5 bg-[#ffbe11] skew-x-[-10deg]"></span>
                                  </div>
                                </div>
                              )}

                              {/* Package Images - UNCHANGED */}
                              <div className="mb-1.5">
                                ...
                                <div className="grid grid-cols-3 gap-1">
                                  {(offer.gallery || [
                                    ...
                                    <img
                                      ...
                                      src={img}
                                      alt="Interior"
                                      className="h-10 w-full object-cover rounded border border-[#004aad]/20"
                                    />
                                  ))}
                                </div>
                              </div>
                              ...
                              <button
                                ...
                                className="w-full bg-[#004aad] hover:bg-[#003a8a] text-white font-bold py-2 rounded-md text-[11px] transition flex items-center justify-center gap-1 shadow-md"
                              >
                                <span>Claim Offer</span>
                                <span className="text-base text-[#ffbe11]">→</span>
                              </button>
                            </div>
                          </div>

                          {/* ===== DESKTOP VIEW - ONLY PADDING INCREASED, UI UNCHANGED ===== */}
                          <div className="hidden md:block">
                            <div className="p-4 grid md:grid-cols-2 gap-2 items-stretch">
                              {/* LEFT SIDE - UNCHANGED */}
                              <div className="flex flex-col justify-start space-y-1.5">
                                <h2 className="text-xl md:text-2xl font-black text-[#004aad] leading-snug">
                                  {offer.title || "3BHK"} <br /> Only For
                                </h2>

                                {/* Price - UNCHANGED */}
                                <div className="mt-1">
                                  <p className="text-2xl md:text-3xl font-extrabold text-[#ffbe11]">
                                    ₹{offer.discounted_price || offer.final_price || "8000"} /-
                                  </p>
                                ...
                                {offer.start_date || offer.end_date || offer.valid_from || offer.valid_to ? (
                                  <div className="mt-2">
                                    <div className="relative inline-block">
                                      <div className="bg-[#004aad] text-white px-3 py-1.5 pr-6 rounded-sm shadow-md skew-x-[-10deg]">
                                        <div className="skew-x-[10deg]">
                                          <p className="text-[9px] font-extrabold uppercase leading-tight text-[#ffbe11]">
                                            LIMITED TIME
                                          </p>
                                      ...
                                      <span className="absolute top-0 right-0 h-full w-2 bg-[#ffbe11] skew-x-[-10deg]"></span>
                                    </div>
                                  </div>
                                ) : null}
                              </div>
                              ...
                              <div className="bg-blue-50/50 rounded-lg p-2.5 border border-[#004aad]/20 flex flex-col justify-between">
                                <div>
                                  <h3 className="text-[10px] font-bold text-[#004aad] mb-1.5">
                                    WHY CHOOSE US?
                                  </h3>
                                  <ul className="space-y-1 text-[9px] text-gray-600">
                                    {(offer.features || [
                                      "Fully Furnished Rooms with AC",
                                      "High-Speed WiFi & Daily Housekeeping",
                                      "Free Laundry & Home Cooked Meals"
                                      ...
                                      <li key={idx} className="flex items-start gap-1">
                                        <span className="text-[#ffbe11] text-xs">•</span>
                                        <span className="truncate">{point.length > 30 ? point.substring(0, 30) + "..." : point}</span>
                                      </li>
                                    ))}
                                  </ul>
                                </div>
                                ...
                                <div className="mt-2 self-end">
                                  <div className="bg-[#ffbe11] text-[#004aad] px-2 py-1 rounded text-[8px] shadow-md">
                                    <p className="uppercase font-bold text-[8px]">Discount</p>
                              ...
                              <div className="grid grid-cols-3 gap-1.5">
                                {(offer.gallery || [
                                  ...
                                  <img
                                    ...
                                    src={img}
                                    alt="Interior"
                                    className="h-12 w-full object-cover rounded border border-[#004aad]/20"
                                  />
                                ))}
                              </div>
                            </div>
                            ...
                            <div className="px-4 pb-4">
                              <button
                                ...
                                className="w-full bg-[#004aad] hover:bg-[#003a8a] text-white font-bold py-2 rounded-md text-xs transition flex items-center justify-center gap-1.5 shadow-md"
                              >
                                <span>Claim Offer</span>
                                <span className="text-base text-[#ffbe11]">→</span>
                              </button>
                    ...
                    <button
                      ...
                      className={`h-1.5 rounded-full transition-all duration-300 shadow-lg ${
                        currentOfferIndex === index
                          ? 'w-5 bg-[#004aad]'
                          : 'w-1.5 bg-white border border-[#004aad]/30 hover:bg-[#ffbe11]/50'
                      }`}
                    />
                  ))}
                </div>
        ...
        {/* ✅ CLAIM OFFER POPUP MODAL - COMPLETELY UNCHANGED */}
        {isClaimPopupOpen && selectedOffer && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-2 sm:p-4 py-3">
            <div className="bg-white border border-[#004aad]/30 rounded-xl shadow-xl w-full max-w-3xl max-h-[85vh] flex flex-col">
              {/* Header */}
              <div
                className="px-4 sm:px-5 py-3 sticky top-0 z-20 flex-shrink-0"
              ...
              >
                <div className="flex justify-between items-center gap-2">
                  <div className="flex items-center gap-2">
                    <span className="text-xl text-[#ffbe11]">🎉</span>
                    <div className="max-w-[200px] sm:max-w-none overflow-hidden">
                      <h3 className="text-base sm:text-lg font-bold text-white truncate">
                        {selectedOffer.title || "Special Offer"}
                      </h3>
                  ...
                  <button
                    onClick={() => setIsClaimPopupOpen(false)}
                    className="text-white/90 hover:text-[#ffbe11] text-lg sm:text-xl transition-colors flex-shrink-0"
                    aria-label="Close popup"
                  >
                    ✕
                  </button>
              ...
              <div className="flex-1 overflow-y-auto">
                ...
                <div className="relative h-48 sm:h-56">
                  <img
                    ...
                    className="w-full h-full object-cover"
                  />
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#004aad]/90 to-transparent p-4">
                    <div className="flex justify-between items-end">
                      <div>
                        <h2 className="text-xl sm:text-2xl font-bold text-white">
                          {selectedOffer.property_name || "SOUL SPACE STUDIO"}
                      ...
                      <div className="bg-[#ffbe11] text-[#004aad] px-3 py-2 rounded-lg shadow-md">
                        <div className="text-lg sm:text-xl font-bold">
                          {selectedOffer.discount_percentage ? `${selectedOffer.discount_percentage}% OFF` :
                            selectedOffer.discount_value ? `₹${selectedOffer.discount_value} OFF` : "SPECIAL OFFER"}
                        </div>
                ...
                <div className="p-4 sm:p-5 border-b border-gray-200">
                  <div className="flex flex-wrap items-center gap-4">
                    <div>
                      <p className="text-sm text-gray-600">Discounted Price</p>
                      <div className="flex items-baseline gap-2">
                        <span className="text-3xl sm:text-4xl font-bold text-[#004aad]">
                          ₹{selectedOffer.discounted_price || selectedOffer.final_price || "8000"}
                        </span>
                        <span className="text-sm text-gray-500">/month</span>
                      </div>
                    ...
                    {selectedOffer.original_price && (
                      <div>
                        ...
                        <div className="flex items-baseline gap-2">
                          ...
                          <span className="text-sm text-[#ffbe11] font-semibold">
                            Save ₹{(selectedOffer.original_price - (selectedOffer.discounted_price || selectedOffer.final_price || 8000)).toLocaleString()}
                          </span>
                        </div>
                      </div>
                  ...
                  {/* Validity */}
                  <div className="mt-4 p-3 bg-blue-50 rounded-lg border-l-4 border-[#ffbe11]">
                    <div className="flex items-center gap-2">
                      <span className="text-[#004aad]">⏰</span>
                      <div>
                        <p className="text-sm font-semibold text-[#004aad]">Limited Time Offer</p>
                ...
                {/* Features */}
                <div className="p-4 sm:p-5 border-b border-gray-200">
                  <h3 className="text-lg font-bold text-[#004aad] mb-3">What's Included</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {(selectedOffer.features || [
                      "Fully Furnished Rooms with AC",
                      "High-Speed WiFi",
                      ...
                      <div key={index} className="flex items-center gap-2">
                        <span className="text-[#ffbe11] font-bold">✓</span>
                        <span className="text-sm text-gray-700">{feature}</span>
                      </div>
                    ))}
                  </div>
                ...
                {(selectedOffer.gallery || selectedOffer.images) && (
                  <div className="p-4 sm:p-5 border-b border-gray-200">
                    <h3 className="text-lg font-bold text-[#004aad] mb-3">Gallery</h3>
                    <div className="grid grid-cols-3 gap-2">
                      {(selectedOffer.gallery || selectedOffer.images || [
                        "https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg",
                        "https://images.pexels.com/photos/1457842/pexels-photo-1457842.jpeg",
                        ...
                        <img
                          ...
                          src={img}
                          alt={`Gallery ${index + 1}`}
                          className="h-24 w-full object-cover rounded-lg border border-[#004aad]/20"
                        />
                      ))}
                    </div>
                  </div>
                ...
                {/* Description */}
                <div className="p-4 sm:p-5 border-b border-gray-200">
                  <h3 className="text-lg font-bold text-[#004aad] mb-3">Description</h3>
                  <p className="text-sm text-gray-700 leading-relaxed">
                    {selectedOffer.description ||
                      "This exclusive offer includes premium amenities and services designed for comfortable living. The package is available for a limited time only. Don't miss this opportunity to experience luxury living at an affordable price."}
                  </p>
                ...
                {/* Terms & Conditions */}
                <div className="p-4 sm:p-5">
                  <h3 className="text-lg font-bold text-[#004aad] mb-3">Terms & Conditions</h3>
                  <ul className="text-sm text-gray-600 space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="text-[#ffbe11]">•</span>
                      <span>Offer valid for new bookings only</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#ffbe11]">•</span>
              ...
              {/* Footer with Action Buttons */}
              <div className="sticky bottom-0 z-20 p-4 sm:p-5 border-t border-gray-200 bg-white">
                <div className="flex flex-col sm:flex-row gap-3">
                  <button
                    onClick={() => setIsClaimPopupOpen(false)}
                    className="px-4 py-3 border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50 transition-colors flex-1"
                  ...
                  <button
                    ...
                    className="px-4 py-3 bg-[#004aad] text-white rounded-lg font-medium hover:bg-[#003a8a] transition-colors flex-1 shadow-md"
                  >
                    Claim Now
                  </button>
                  <button
                    ...
                    className="px-4 py-3 bg-[#ffbe11] text-[#004aad] rounded-lg font-medium hover:bg-[#e6a900] transition-colors flex-1 shadow-md"
                  >
                    Contact Property
                  </button>
                </div>
