...
export default function FloatingActions() {
  ...
  <a
    ...
    className="fixed bottom-24 right-6 z-50 h-10 w-10 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-300"
