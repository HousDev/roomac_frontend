...
//   const totalImages = propertyImages.length;
//   const currentImage = !imageError && totalImages > 0
//     ? propertyImages[currentImageIndex].startsWith('http')
...
//       }}
//     >
//       <div className="relative overflow-hidden rounded-2xl bg-white shadow-md hover:shadow-2xl transition-all duration-500 group-hover:-translate-y-2 h-[500px] flex flex-col cursor-pointer border border-slate-100">

//         {/* Image area */}
//         <div className="relative h-52 sm:h-56 md:h-60 overflow-hidden rounded-t-2xl flex-shrink-0 bg-slate-100">
//           <img
//             src={currentImage}
//             alt={propertyName}
//             className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
...
//               <button
//                 onClick={prevImage}
//                 className="absolute left-2 top-1/2 -translate-y-1/2 z-20 h-8 w-8 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center shadow-md hover:bg-white transition-all opacity-0 group-hover:opacity-100 hover:scale-110"
...
//               <button
//                 onClick={nextImage}
//                 className="absolute right-2 top-1/2 -translate-y-1/2 z-20 h-8 w-8 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center shadow-md hover:bg-white transition-all opacity-0 group-hover:opacity-100 hover:scale-110"
...
//           {/* Rating pill — top left */}
//           <div className="absolute top-3 left-3 z-10 flex items-center gap-1.5 bg-white/95 backdrop-blur-sm px-3 py-1.5 rounded-full shadow-lg">
//             <Star className="h-3.5 w-3.5 fill-yellow-400 text-yellow-400" />
//             <span className="text-xs font-bold text-slate-800">{rating}</span>
//             {reviewCount > 0 && (
...
//           <button
//             onClick={handleHeartClick}
//             className="absolute top-3 right-3 z-10 h-9 w-9 rounded-full bg-white/95 backdrop-blur-sm flex items-center justify-center shadow-lg hover:scale-110 transition-all"
...
//           {/* Tags */}
//           <div className="absolute bottom-3 left-3 flex flex-wrap gap-1.5 z-10 max-w-[70%]">
//             {propertyTags.slice(0, 2).map((tag: string, ti: number) => (
//               <span
//                 key={ti}
//                 className={`px-2.5 py-1 rounded-full text-xs font-semibold shadow-md ${getTagColor(tag)}`}
//               >
//                 {tag.length > 15 ? tag.substring(0, 15) + '...' : tag}
//               </span>
//             ))}
//             {propertyTags.length === 0 && propertyType && (
//               <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-slate-700 text-white shadow-md capitalize">
//                 {propertyType}
//               </span>
//             )}
//           </div>
...
//             {/* Price on the right */}
//             <div className="text-right flex-shrink-0">
//               <p className="text-xs text-slate-500 font-medium whitespace-nowrap">Starting from</p>
//               <p className="text-lg font-bold text-[#0249a8] whitespace-nowrap">
//                 ₹{Number(propertyPrice).toLocaleString()}
//                 <span className="text-sm text-slate-400 font-normal ml-0.5">/mo</span>
//               </p>
//             </div>
//           </div>
...
//                 <span
//                   key={ai}
//                   className={`px-2 py-1 rounded-md border text-xs font-medium ${getAmenityColor(ai)}`}
//                 >
//                   {String(a).length > 12 ? String(a).substring(0, 12) + '...' : String(a)}
//                 </span>
//               ))}
//               {amenities.length > 5 && (
//                 <span className="px-2 py-1 rounded-md border border-slate-200 text-xs text-slate-500 bg-slate-50">
...
// export const PropertyCardSkeleton = memo(function PropertyCardSkeleton() {
//   return (
//     <div className="h-[500px] rounded-2xl bg-white shadow-md overflow-hidden border border-slate-100">
//       <div className="h-52 sm:h-56 md:h-60 bg-gradient-to-r from-slate-200 to-slate-300 animate-pulse" />
//       <div className="p-4 sm:p-5 space-y-4">
//         <div className="flex justify-between">
//           <div className="space-y-2 flex-1 mr-3">
//             <div className="h-5 w-3/4 bg-gradient-to-r from-slate-200 to-slate-300 rounded animate-pulse" />
//             <div className="h-3 w-1/2 bg-gradient-to-r from-slate-200 to-slate-300 rounded animate-pulse" />
//           </div>
//           <div className="space-y-1">
//             <div className="h-3 w-16 bg-gradient-to-r from-slate-200 to-slate-300 rounded animate-pulse ml-auto" />
//             <div className="h-5 w-20 bg-gradient-to-r from-slate-200 to-slate-300 rounded animate-pulse" />
//           </div>
//         </div>
//         <div className="h-3 w-full bg-gradient-to-r from-slate-200 to-slate-300 rounded animate-pulse" />
//         <div className="h-3 w-2/3 bg-gradient-to-r from-slate-200 to-slate-300 rounded animate-pulse" />
//         <div className="flex gap-2">
...
//           <div className="flex gap-2">
//             <div className="h-9 flex-1 bg-gradient-to-r from-slate-200 to-slate-300 rounded-lg animate-pulse" />
//             <div className="h-9 flex-1 bg-gradient-to-r from-slate-200 to-slate-300 rounded-lg animate-pulse" />
//             <div className="h-9 flex-1 bg-gradient-to-r from-slate-200 to-slate-300 rounded-lg animate-pulse" />
//           </div>
//         </div>
...
// }) {
//   return (
//     <div className="h-[500px] rounded-2xl bg-white shadow-md flex flex-col items-center justify-center p-6 text-center border border-slate-100">
//       <AlertCircle className="h-12 w-12 text-red-400 mb-4" />
//       <h3 className="text-lg font-semibold text-slate-800 mb-2">
//         Failed to Load Property
//       </h3>
...
//         <Button
//           onClick={onRetry}
//           className="bg-[#0249a8] hover:bg-[#023a88] text-white shadow-md hover:shadow-lg transition-all"
//         >
...
// PropertyCardError.displayName = 'PropertyCardError';
...
//           {hasFilters
//             ? 'Try adjusting or clearing your search filters to see more properties.'
//             : "We couldn't find any properties at the moment. Check back later!"}
//         </p>
//         {hasFilters && onClearFilters && (
//           <Button
//             onClick={onClearFilters}
//             className="bg-[#0249a8] hover:bg-[#023a88] text-white font-semibold rounded-full px-8 shadow-md hover:shadow-lg transition-all"
//           >
//             Clear Filters
//           </Button>
//         )}
...
// PropertyCardEmpty.displayName = 'PropertyCardEmpty';
