...
/* Format salutation so first letter is capital: "miss" → "Miss", "MRS" → "Mrs" */
const formatSalutation = (salutation: string) =>
  salutation ? capFirst(salutation.trim()) : "";
...
const catColors: Record<string, { bg: string; text: string; dot: string }> = {
  ...
  "Internet / WiFi":   { bg: "#E0F7FA", text: "#006064", dot: "#00ACC1" },
  Furniture:           { bg: "#FFF8E1", text: "#E65100", dot: "#FFB300" },
  "Furniture & Equipment": { bg: "#FFF8E1", text: "#E65100", dot: "#FFB300" },
  Cleaning:            { bg: "#FCE4EC", text: "#880E4F", dot: "#E91E63" },
  Security:            { bg: "#E8EAF6", text: "#1A237E", dot: "#3F51B5" },
  "Food / Kitchen":    { bg: "#E8F5E9", text: "#1B5E20", dot: "#66BB6A" },
  Insurance:           { bg: "#E3F2FD", text: "#0D47A1", dot: "#42A5F5" },
  Marketing:           { bg: "#FFF3E0", text: "#E65100", dot: "#FFA726" },
  Miscellaneous:       { bg: "#ECEFF1", text: "#37474F", dot: "#78909C" },
  "Office Supplies":   { bg: "#F3E5F5", text: "#6A1B9A", dot: "#AB47BC" },
  "Property Rent":     { bg: "#E8EAF6", text: "#283593", dot: "#5C6BC0" },
  "Repair & Renovation": { bg: "#FBE9E7", text: "#BF360C", dot: "#FF7043" },
...
export default function ExpensesManagement() {
  ...
  const loadMasterData = useCallback(async () => {
    ...
    // ── CHANGED: Categories from Masters > Common tab > "Expenses Category" ──
    try {
    ...
    // ── Staff list: format salutation first letter capital ──
    try {
      const staff = await getAllStaff();
      setStaffList(
        (staff || []).map((s: any) => {
          const sal = s.salutation
            ? formatSalutation(s.salutation) + " "
            : "";
          return {
            id: String(s.id),
            name: `${sal}${s.name}`.trim(),
          };
        })
      );
    } catch {}
  ...
  const filtered = useMemo(
    () =>
      expenses.filter((e) => {
        ...
        if (filterProp !== "All" && e.property_name !== filterProp)
          return false;
        if (
          search &&
          ![
  ...
  function openEdit(exp: any) {
    setForm({
      ...
      amount: exp.amount,
      paid_by_staff_id: exp.paid_by_staff_id
        ? String(exp.paid_by_staff_id)
        : "",
  ...
  // Unique property/category names for filter dropdowns
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "sticky", top: 0, zIndex: 10, background: "" }}>
        {/* Top bar */}
        <div
          style={{
            background: "",
      ...
      <div style={{ padding: "" }}>
        ...
        >
          ...
          >
            ...
            >
              <span
                style={{ fontSize: 12, color: "#1B7A4E", fontWeight: 700 }}
              >
                Paid:{" "}
                {fmt(
                  filtered
              ...
              <span
                style={{ fontSize: 12, color: "#B45309", fontWeight: 700 }}
              >
                Pending:{" "}
                {fmt(
                  filtered
              ...
              <span
                style={{ fontSize: 13, color: "#1A2B6D", fontWeight: 800 }}
              >
                Total:{" "}
                {fmt(
                  filtered.reduce(
            ...
            <div style={{ padding: "20px 22px" }}>
              ...
              <div style={{ marginBottom: 22 }}>
                ...
                >
                  ...
                  {/* ── CHANGED: label is now "Expenses Category" ── */}
                  <div>
                    <Label required>Expenses Category</Label>
                    <SearchableDropdown
                      options={categories}
              ...
              <div style={{ marginBottom: 22 }}>
                <SectionHead n="2" title="Payment Details" />
                <div
                  style={{
                    display: "grid",
                    gridTemplateColumns:
                ...
                >
                  ...
                  {/* ── CHANGED: salutation first letter capital ── */}
                  <div>
                  ...
                  {/* ── Description moved here (full width) ── */}
              ...
              >
                ...
                <div>
                  ...
                  <span
                    style={{
                      background:
                        viewItem.status === "Paid" ? "#E8F5F0" : "#FFF3E0",
                      color:
                        viewItem.status === "Paid" ? "#1B7A4E" : "#B45309",
                      padding: "3px 12px",
                      borderRadius: 20,
                      fontSize: 12,
                      fontWeight: 600,
                ...
                <div>
                  ...
                  <div
                    style={{ fontSize: 12, color: "#B0BAC9", fontWeight: 400 }}
                  >
                  ...
                  <div style={{ gridColumn: "1/-1" }}>
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div
                          style={{ fontSize: 10, color: "#8892A4", marginTop: 1 }}
                        >
                          {viewItem.receipt_name?.toLowerCase().endsWith(".pdf")
                            ? "PDF Document"
                            : "Image file"}
