          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {values.map((value, index) => {
              ...
              return (
                ...
                >
                  <Card 
                    className="border-0 shadow-xl hover:shadow-2xl transition-all duration-500 group relative overflow-hidden bg-white/80 backdrop-blur-sm hover:bg-white/90 hover:scale-105 h-full min-h-[400px]"
                  ...
                  >
                    ...
                    <CardContent className="p-8 relative z-10 h-full">
                      <div className={`h-20 w-20 bg-gradient-to-br ${value.color} rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-125 transition-all duration-500 relative overflow-hidden`}>
                        ...
                        <Icon className="h-10 w-10 text-white relative z-10 group-hover:scale-110 transition-transform duration-500" />
                      </div>
