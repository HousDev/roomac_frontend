...
export default function AboutStory({ team }: AboutStoryProps) {
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-16">
            <div className="text-center mb-8">
              <Badge className="bg-gradient-to-r from-blue-200 to-cyan-200 text-[#094ca3] border-0 px-5 py-2 shadow-sm mb-4">
                <span className="font-['Inter'] text-xs font-semibold tracking-[0.2em] uppercase">Our Story</span>
              </Badge>
  ...
  <p className="font-['Cormorant_Upright'] text-[14px] md:text-[16px] text-slate-600 leading-relaxed font-medium tracking-wide">
  ...
  <div className="group relative">
    ...
    <Card className="relative overflow-hidden border-0 bg-white shadow-sm hover:shadow-xl transition-all duration-500">
      <CardContent className="p-6 md:p-8">
        <div className="mb-4">
          <h3 className="font-['Playfair_Display'] text-2xl font-semibold text-slate-900 mb-1 group-hover:text-[#004AAD] transition-colors duration-300">
            Our Mission
          </h3>
  ...
  <div className="group relative">
    ...
    <Card className="relative overflow-hidden border-0 bg-white shadow-sm hover:shadow-xl transition-all duration-500">
      <CardContent className="p-6 md:p-8">
        <div className="mb-4">
          <h3 className="font-['Playfair_Display'] text-2xl font-semibold text-slate-900 mb-1 group-hover:text-slate-700 transition-colors duration-300">
            Our Vision
          </h3>
