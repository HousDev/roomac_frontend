...
//       // Price filter - FIXED: Using the price from property
//       const price = property.starting_price || property.price || property.monthly_rent || property.rent || 0;
      
//       // Debug log to see what prices are being filtered
//       if (selectedPriceKey !== "Any Price") {
//         console.log(`Property: ${property.name}, Price: ${price}, Filter: ${selectedPriceKey}`);
//       }
...
//     if (selectedAmenity) parts.push(selectedAmenity);
