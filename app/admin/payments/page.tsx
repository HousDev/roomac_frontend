...
//     // Get all rent payments for this tenant
//     const tenantPayments = allPayments.filter(p => 
//       p.tenant_id.toString() === tenantId && 
//       p.payment_type === 'rent'
//     );

//     // Generate last 6 months of rent history
//     const months = [];
//     let totalPending = 0;
//     let totalPaid = 0;
...
//       // Get the latest payment date for this month
//       const latestPayment = monthPayments
//         .filter(p => p.status === 'completed')
...
//       if (i === 0) {
//         // Current month - add pending to total
//         totalPending += pendingAmount;
//       } else if (isPastMonth) {
//         // Past months - add unpaid to total pending
//         totalPending += pendingAmount;
//       }
//       totalPaid += paidAmount;
//     }

//     // Calculate next due date (15th of current month or next month if past)
...
//     const previousPending = history.totalPending - (history.months[history.months.length-1]?.pendingAmount || 0);
//     const currentMonthPending = history.months[history.months.length-1]?.pendingAmount || 0;
//     const totalToPayNow = history.currentMonthRent + previousPending;
...
//             <p className="text-xs font-bold text-blue-700">₹{history.currentMonthRent.toLocaleString()}</p>
//           </div>
//           <div className="bg-yellow-50 p-2 rounded-lg border border-yellow-100">
//             <p className="text-[8px] text-yellow-600">Total Pending</p>
//             <p className="text-xs font-bold text-yellow-700">₹{history.totalPending.toLocaleString()}</p>
//           </div>
//           <div className="bg-green-50 p-2 rounded-lg border border-green-100">
//             <p className="text-[8px] text-green-600">Total Paid</p>
//             <p className="text-xs font-bold text-green-700">₹{history.totalPaid.toLocaleString()}</p>
//           </div>
//         </div>
...
//                 <th className="p-2 text-right font-medium">Rent</th>
...
//                 const isCurrentMonth = index === history.months.length - 1;
                
//                 return (
//                   <tr key={`${month.month}-${month.year}`} className="border-b border-slate-200 hover:bg-slate-50">
//                     <td className="p-2 font-medium">
//                       {month.month}
//                       {isCurrentMonth && (
//                         <span className="ml-1 text-[8px] text-blue-500">(Current)</span>
//                       )}
//                     </td>
//                     <td className="p-2 text-right font-medium">₹{month.rentAmount.toLocaleString()}</td>
//                     <td className="p-2 text-right text-green-600">₹{month.paidAmount.toLocaleString()}</td>
...
//                       {month.paymentDate ? format(new Date(month.paymentDate), 'dd MMM yy') : '-'}
//                     </td>
//                   </tr>
//                 );
//               })}
...
//               <tr>
//                 <td colSpan={3} className="p-2 text-right">Total Outstanding:</td>
//                 <td className="p-2 text-right text-yellow-600 font-bold">
...
//         {history.totalPending > 0 && (
//           <div className="bg-blue-50 p-3 rounded-lg border border-blue-200 mt-3">
//             <p className="text-[10px] font-medium text-blue-800 mb-2">Payment Calculation Summary:</p>
//             <div className="space-y-1.5 text-[9px]">
//               <div className="flex justify-between items-center">
//                 <span className="text-slate-600">Current Month Rent:</span>
//                 <span className="font-medium">₹{history.currentMonthRent.toLocaleString()}</span>
//               </div>
//               <div className="flex justify-between items-center">
//                 <span className="text-slate-600">Previous Pending Amount:</span>
//                 <span className="font-medium text-yellow-600">₹{previousPending.toLocaleString()}</span>
//               </div>
//               {currentMonthPending > 0 && (
//                 <div className="flex justify-between items-center">
//                   <span className="text-slate-600">Current Month Pending:</span>
//                   <span className="font-medium text-yellow-600">₹{currentMonthPending.toLocaleString()}</span>
//                 </div>
//               )}
//               <div className="flex justify-between items-center pt-2 mt-1 border-t border-blue-200">
//                 <span className="font-semibold text-blue-800">Total to Pay Now:</span>
//                 <span className="font-bold text-blue-700 text-sm">
//                   ₹{totalToPayNow.toLocaleString()}
//                 </span>
//               </div>
//               <p className="text-[7px] text-slate-500 mt-1 italic">
//                 * Includes current month rent + previous pending amounts
//               </p>
//             </div>
//           </div>
//         )}
