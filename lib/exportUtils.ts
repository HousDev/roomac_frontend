...
export const handleExportTypes = async (options?: ExportOptions) => {
  ...
  const url = `${import.meta.env.VITE_API_URL || ''}/api/masters/export/types?${params}`;
...
export const handleExportValues = async (typeId: number, typeName: string, options?: ExportOptions) => {
  ...
  const url = `${import.meta.env.VITE_API_URL || ''}/api/masters/export/values/${typeId}?${params}`;
...
export const handleExportAllData = async (options?: ExportOptions) => {
  const url = `${import.meta.env.VITE_API_URL || ''}/api/masters/export/all`;
